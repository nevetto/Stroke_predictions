...
from data_src.components.model_trainer import ModelTrainerConfig
from data_src.components.model_trainer import ModelTrainer
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('notebook\dataset\healthcare-dataset-stroke-data1.csv')
